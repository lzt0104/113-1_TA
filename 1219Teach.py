...
#資料儲存容器(tuple 元組、list串列、dict字典及set集合)
...
print(t3[2]) #index 取出 element元素

t3[2] = 4 #無法更改TypeError: 'tuple' object does not support item assignment
...
print("共有%d位學生"%(scorelen))
print("本班總成績：%d分，平均成績：%.2f分"%(scoresum,scoreavg))